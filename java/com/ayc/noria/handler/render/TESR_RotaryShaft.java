...
public class TESR_RotaryShaft extends TileEntitySpecialRenderer<TE_RotaryShaft>{
    ...
    private IBakedModel getBakedModel() 
    {
        if (bakedModel == null) {
            try {
                model = ModelLoaderRegistry.getModel(new ResourceLocation(Reference_Static.MOD_ID, "block/obj/rotaryshaftjoint.obj"));
            } catch (Exception e) {
    ...
    @Override
    public void renderTileEntityAt(TE_RotaryShaft te, double x, double y, double z, float partialTicks, int destroyStage) {
